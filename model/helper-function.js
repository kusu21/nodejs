 ...
 */
function isFSJDateFormat(dateString) {
...
function dateToFSJDate(dateParam) {
 ...
 * @returns {string} FSJ date format i.e. YYYY-MM-DD
 */
function dateStringToFSJDate(dateString) {
  const myDate = new Date(dateString);
  return dateToFSJDate(myDate);
}
 ...
 */
function getFSJFormatToday() {
  const today = new Date();
  return dateToFSJDate(today);
}
 ...
 */
function getFSJFormatYesterday() {
  const today = new Date();
  const yesterday = new Date();
  yesterday.setDate(today.getDate() - 1);
  return dateToFSJDate(yesterday);
}
 ...
 * @returns {boolean} Representing whether the format is correct or not
 */
function isFSJTimeFormat(timeString) {
...
module.exports.isFSJDateFormat = isFSJDateFormat;
module.exports.dateToFSJDate = dateToFSJDate;
module.exports.dateStringToFSJDate = dateStringToFSJDate;
module.exports.getFSJFormatToday = getFSJFormatToday;
module.exports.getFSJFormatYesterday = getFSJFormatYesterday;
module.exports.isFSJTimeFormat = isFSJTimeFormat;
